...
//    context.add(new PatientAdder(space, grid).WithTimeSpan(60));
    ...
    InfectionStateType pinfectionStateSusceptible = new InfectionStateType(InfectionStatus.Susceptible, 0.02);
    InfectionStateType pinfectionStateExposed = new InfectionStateType(InfectionStatus.Exposed, 3, 3);
    InfectionStateType pinfectionStateInfected = new InfectionStateType(InfectionStatus.Infected, 14, 14);
    InfectionStateType pinfectionStateRecovered = new InfectionStateType(InfectionStatus.Recovered, 30, 120);
    
    // Set infection state ordering
    pinfectionStateSusceptible.setNextState(pinfectionStateExposed);
    pinfectionStateExposed.setNextState(pinfectionStateInfected);
    pinfectionStateInfected.setNextState(pinfectionStateRecovered);
    ...
    // add Locations here 
//    Location home = new Location("Home", context, space, grid, 40, 40, 2, 2, 3, 20, "Left");
